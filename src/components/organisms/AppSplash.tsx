...
/**
 * Branded splash shown while the persisted Zustand stores rehydrate from
 * AsyncStorage (see `useStoresHydrated`). Once hydration finishes the root
 * layout swaps this out for the navigator, and the `index` route forwards the
 * user to their correct destination.
 *
